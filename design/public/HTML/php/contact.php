<?php
	...
	$CONFIG = array(
		...
		'messages'=>array(
			...
			'form_error'  =>'<h4>The following errors were encountered</h4><ul><li>%s</li></ul>', 
			'form_success'=>'<h4>Thank you</h4>Your message has been sent, we\'ll get back to you shortly :)', 
			'form_fields' =>array(
				'name'=>array(
	...
	$response = array();
	$validator = new Validation( sanitize( $_POST[ 'ContactForm' ] ) );
	$validator
		->pre_filter('trim')
